...
export default function DirtTurnsToGold(props) {
  const { nodes, materials } = useGLTF("./buttons/new/dirtTurnsToGold.glb");
  const button = useRef()
  const trim = useRef()
  const text = useRef()
...
useGLTF.preload("./buttons/new/dirtTurnsToGold.glb");
