...
export default function CowBoysLikeMeDo(props) {
  const { nodes, materials } = useGLTF("./buttons/new/cowboysLikeMeDo.glb");
  const button = useRef()
  const trim = useRef()
  const text = useRef()
...
useGLTF.preload("./buttons/new/cowboysLikeMeDo.glb");
