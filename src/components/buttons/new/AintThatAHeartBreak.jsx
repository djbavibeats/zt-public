...
export default function AintThatAHeartBreak(props) {
  const { nodes, materials } = useGLTF("./buttons/new/aintThatAHeartBreak.glb");
  const button = useRef()
  const trim = useRef()
  const text = useRef()
  ...
  return (
    ...
    <mesh
      castShadow={ false }
      receiveShadow={ false }
      geometry={nodes.ButtonText.geometry}
...
useGLTF.preload("./buttons/new/aintThatAHeartBreak.glb");
